...
const Assignments = () => {
  return (
    <>
      ...
      <h3>Challenges</h3>
      <p>My columns in Foodpersonality since 2009 are included in this site.</p>
      ...
      <p>
        ...
        days in Ghent.
        <br />
        A fascinating learning experience we had with great insights on both the
        external as internal side of life.
        <br />
        <br />
        ...
        <br />
        <br />
        For an international Group of Foodstores I investigated the next step in
        their format portfolio.
      </p>
      <p>
        ...
        <br />
        One of their biggest clients from the States had a streetology tour with
        me in London.
        <br />
        With the designteam we also had an investigation in Mumbay and Tokyo to
        see how people clean their toilets.
      </p>
      <p>
        ...
        of transition cities in Detroit, Cleveland, Pittsburgh and Philadelphia.
        <br />
      ...
      <p>
        ...
        <br />
        <br />
        It strikes me how the global reshuffle has an impact on the development
        of cities, public space, homes/living, offices and retail.
        <br />
