...
const Manifesto = () => {
  const ManifestoItems = [
    ...
    },
    {
      ...
      text:
        "Successes are not achieved, even though they are often claimed, by masters in finance. A success is an opportunity into a reality. And there are opportunities everywhere: waiting to be realised. Look carefully, and <u>with new eyes</u>, that's often when you'll be able to make them work for you."
    },
    {
      key: 3,
    ...
    },
    {
      ...
      text:
        "When we are not loyal to our clients, their employees and suppliers, we shouldn't expect to rely on loyalty and commitment from them. It doesn't work that way."
    },
    {
      key: 22,
