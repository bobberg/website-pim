  ...
  return (
    <>
      <p>
        ...
        <br />
        If there are any questions about the information please do get in touch.
        <br />
        <br />
        ...
        <br />
        While taking people on my discovery tours throughout the world, I teach
        what daily insights can offer.
        <br />
